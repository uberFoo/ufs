...
pub(in crate::runtime) const LIST_FILES_NAME: &'static str = "list_files";
...
/// Open a file
pub(in crate::runtime) const OPEN_FILE_NAME: &'static str = "open_file";
pub(in crate::runtime) const OPEN_FILE_INDEX: usize = 3;
/// Close from a file
pub(in crate::runtime) const CLOSE_FILE_NAME: &'static str = "__rust_close_file";
pub(in crate::runtime) const CLOSE_FILE_INDEX: usize = 4;
/// Write to a file
pub(in crate::runtime) const WRITE_FILE_NAME: &'static str = "__rust_write_file";
pub(in crate::runtime) const WRITE_FILE_INDEX: usize = 5;
/// Read from a file
pub(in crate::runtime) const READ_FILE_NAME: &'static str = "read_file";
